...
- Settings + Account Settings sheet: Site Admin is two rows — Results and Account deletions.
...
1. Phone-review as a super-admin: Settings → Site Admin → Account deletions; request deletion from a throwaway account and confirm it appears; Clear request; confirm non-super-admin is redirected.
